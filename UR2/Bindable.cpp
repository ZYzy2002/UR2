...
Bindable::Bindable(ComPtr<ID3D11Device> pDevice, ComPtr<ID3D11DeviceContext> pContext)
	:pDevice{ pDevice }, pContext{ pContext }
{

}

Microsoft::WRL::ComPtr<ID3D11Device> Bindable::GetDevice()const
{
	return pDevice;
}

Microsoft::WRL::ComPtr<ID3D11DeviceContext> Bindable::GetContext()const
{
	return pContext;
}
